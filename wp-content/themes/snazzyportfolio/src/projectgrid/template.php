...
<section class="sp-flex sp-flex-col md:sp-flex-row sp-items-center sp-justify-center">
  <?php while ($custom_query->have_posts()) :
    ...
    <div class="sp-grid sp-grid-cols-1 md:sp-grid-cols-2 lg:sp-grid-cols-3 sp-gap-4"><a href="<?php the_permalink(); ?>">
        <div class="
          sp-border-2 
          ...
          <div class="sp-w-full sp-p-4">
            ...
            <p class="sp-flex sp-flex-wrap sp-gap-2 sp-flex-row sp-items-center sp-justify-start sp-text-xs md:sp-text-sm">
              <span class="sp-border-white sp-inline-block sp-px-2 sp-py-1 sp-font-semibold sp-bg-teal-400/10 sp-text-teal-300 sp-leading-5 sp-rounded-full">CSS</span>
            </p>
          </div>
        </div>
      </a>
